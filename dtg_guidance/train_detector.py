"""Train CutAddPaste detector with dataset processing splits.

This script uses CutAddPaste's Trainer and data_generator to keep behavior
consistent with the original pipeline. It optionally reports split statistics.
"""
...
def main():
    ...
    # Optional split stats with DTG windowing for reporting
